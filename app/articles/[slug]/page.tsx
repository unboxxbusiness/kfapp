...
export default async function ArticlePage({ params }: PageProps) {
  ...
  // Fetch lightweight recent article summaries for the post details page (excluding current article)
  const recentArticlesList = await getRecentArticleSummaries(6);
