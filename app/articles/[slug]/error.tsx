...
export default function ArticleErrorBoundary({
  ...
  useEffect(() => {
    console.error('[Article Error Boundary caught error]:', error);
  }, [error]);
      ...
      <div className="max-w-md w-full p-8 rounded-3xl border-3 border-[#14213D] bg-white shadow-[8px_8px_0_0_#14213D] text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#14213D]/80 font-medium leading-relaxed">
            The requested college guide could not be rendered right now. Our servers may be updating the data.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          >
            <ArrowLeft className="w-3.5 h-3.5 text-[#FCA311]" />
