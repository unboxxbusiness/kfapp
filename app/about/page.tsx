        ...
        <section className="py-14 sm:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-10 sm:space-y-14">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-[#000000]/90 leading-relaxed font-semibold">
                    Kampus Filter is a higher education decision network and admissions research platform. Designed with a student-first philosophy, we combine verified campus partnerships, official fee breakdowns, and objective benchmarks to make college discovery transparent and accessible across India.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-10 rounded-2xl border-2 sm:border-3 border-[#14213d] bg-white shadow-[6px_6px_0_0_#14213d] space-y-4">
              ...
              <div className="space-y-4 text-sm sm:text-base text-[#14213d]/85 leading-relaxed">
                <p>
                  Choosing a university is one of the most important decisions of your life. Too often, students navigate fragmented websites, unclear fee structures, and confusing admissions pathways without reliable guidance.
                </p>
                <p>
                  Kampus Filter bridges this gap by collaborating directly with accredited universities, official admissions desks, and institutional researchers. When you explore or shortlist colleges through our network, you receive verified curriculum data, transparent fee audits, and direct connectivity with official university counseling teams — ensuring genuine guidance without third-party broker confusion.
                </p>
                <p className="font-bold text-[#14213d] italic">
                  A structured decision engine connecting ambitious students with the right universities.
                </p>
              </div>
            </div>
