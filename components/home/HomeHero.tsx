        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#14213D]/85 max-w-2xl font-medium leading-relaxed">
              India’s student-first decision network. Compare real fee breakdowns, official cutoffs, and institutional placement insights free from sponsored college rankings.
            </p>
